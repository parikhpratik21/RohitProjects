...
namespace DBCON
{
    ...
    public NotifyIcon a = new NotifyIcon();
         ...
         public void insertOutsms(int ch, string to,string smstext,string reasonforsend,DateTime datereceived,string status)
        {
         ...
         public void updatesetting(int id, string plannigtime, string target, string display, string displaytext, string s1start, string s1end, string s1b1start, string s1b1end, string s1b2start, string s1b2end,string weekoff,string ip,string port,string lunchstart,string lunchend,string scrollspeed,string myip,string myport,string file, string brightNess, string labelText)
        {
            try
            {
                string cmnd = "";
         ...
         public void updateproduction(int id, string tagettotal, string plan, string planntotal, string actual, string Actualtotal)
         {
             try
             {
                 string cmnd = "";
                 cmnd = "UPDATE       PRODUCTION SET  TARGETTOTAL = '" + tagettotal + "', PLANNING = '" + plan + "', PLANNINGTOTAL = '" + planntotal + "', ACTUAL = '" + actual + "', ACTUALTOTAL ='" + Actualtotal + "'WHERE  (PRODUCTION.ID = 1)";
